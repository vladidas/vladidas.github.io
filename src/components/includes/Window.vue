...
<script>
    export default ({
        ...
        mounted() {
            this.$refs.window.style = this.application.style;
            this.$refs.window.style.left = (Math.random() * window.innerWidth) + 'px';
            this.$refs.window.style.top = (Math.random() * window.innerHeight) + 'px';
        },
